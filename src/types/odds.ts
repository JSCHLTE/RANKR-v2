...
export interface PlayerMarket extends TotalMarket { yesOdds?: number | null; noOdds?: number | null }
...
export interface PlayerProp { playerId: string; sleeperId?: string; playerName: string; team: string; category: string; market: string; displayName: string; betType?: "ou" | "yn"; sportsbooks: BookMap<PlayerMarket> }
